...
async def track_seats():
    async with async_playwright() as p:
        ...
        try:
            await page.wait_for_selector("div[class*='seat']", timeout=20000)
            ...
            print(f"[{timestamp}] Found {total_seats} total seats. {booked_count} are booked.")

        except Exception as e:
            print(f"Error: Could not find seats. The page layout might have changed. {e}")
